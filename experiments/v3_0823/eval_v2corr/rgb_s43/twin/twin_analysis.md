...
on: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/eval_v2corr/rgb_s43/per_frame_on.csv` · off: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/eval_v2corr/rgb_s43/per_frame_off.csv` · manifest: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/dataset_manifest_v2corr.json`
...
pairs found **408** · pose-matched (kept) **366** · excluded **42** · kept pairs carrying >=1 GT cell **327** (delta_score > 0 in 302/327)
...
|---|---|---|---|
| V | 177 | 0.3466 [0.2982, 0.3966] * | 0.3408 [0.2924, 0.3901] * |
| E | 45 | 0.2119 [0.1602, 0.2655] * | 0.1870 [0.1378, 0.2395] * |
| H | 96 | 0.3587 [0.3117, 0.4079] * | 0.3571 [0.3101, 0.4063] * |
| all | 366 | 0.3315 [0.2998, 0.3639] * | 0.3200 [0.2898, 0.3506] * |
...
| 3b [8,12) m | 327 | 0.3335 [0.3022, 0.3656] * | 96 | 0.3587 [0.3118, 0.4079] * |
...
| scene07 | 30 | 42 | 0.42 | 0.7872 | 0.7394 |
...
per-pair rows: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/eval_v2corr/rgb_s43/twin/twin_pairs.csv` (`kept`/`mismatch` carry the pose-filter verdict).
