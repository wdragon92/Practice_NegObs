...
| cell FPR (negative cells of on frames) | 0.0168 [0.0054, 0.0305] |
...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.9403 [0.8958, 0.9780] |
| cell recall | 1.0000 [1.0000, 1.0000] |
| cell precision | 0.8873 [0.8113, 0.9570] |
...
|---|---|---|---|
| cell_f1 | 0.9000 | 0.9403 | 0.9268 |
| cell_recall | 1.0000 | 1.0000 | 0.9048 |
| cell_precision | 0.8182 | 0.8873 | 0.9500 |
...
| cell_fpr_on_neg | 0.0216 | 0.0168 | 0.0072 |
