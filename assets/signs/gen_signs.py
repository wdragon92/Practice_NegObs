# -*- coding: utf-8 -*-
"""Korean signage texture generation (shared layer — brief v5).
Run: python assets/signs/gen_signs.py  ->  assets/signs/sign_*.png
Style follows Korean public signage convention (warning = yellow triangle/black,
guidance = blue panel/white, prohibition = red border).
"""
import os
...
def panel(name, size, bg, fg, text, sub=None, border=None, tri=False):
    ...
    if tri:  # warning triangle pictogram (top center)
...
# Warning (yellow) — adjacency to a drop = cue for inferring the hidden structure
