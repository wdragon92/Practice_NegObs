...
| cell FPR (negative cells of on frames) | 0.0576 [0.0243, 0.0951] |
...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.8400 [0.7651, 0.9209] |
| cell recall | 1.0000 [1.0000, 1.0000] |
| cell precision | 0.7241 [0.6196, 0.8533] |
...
|---|---|---|---|
| cell_f1 | 0.7925 | 0.8400 | 0.8636 |
| cell_recall | 1.0000 | 1.0000 | 0.9048 |
| cell_precision | 0.6562 | 0.7241 | 0.8261 |
...
| cell_fpr_on_neg | 0.0791 | 0.0576 | 0.0288 |
