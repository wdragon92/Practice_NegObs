...
on: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/eval_v2corr/depth_s43/per_frame_on.csv` · off: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/eval_v2corr/depth_s43/per_frame_off.csv` · manifest: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/dataset_manifest_v2corr.json`
...
pairs found **408** · pose-matched (kept) **366** · excluded **42** · kept pairs carrying >=1 GT cell **327** (delta_score > 0 in 306/327)
...
|---|---|---|---|
| V | 177 | 0.8481 [0.8053, 0.8881] * | 0.8537 [0.8135, 0.8910] * |
| E | 45 | 0.5931 [0.4498, 0.7355] * | 0.5931 [0.4498, 0.7355] * |
| H | 96 | 0.4403 [0.3516, 0.5276] * | 0.4505 [0.3624, 0.5360] * |
| all | 366 | 0.6780 [0.6328, 0.7229] * | 0.6152 [0.5702, 0.6596] * |
...
| 3b [8,12) m | 327 | 0.6548 [0.6089, 0.7004] * | 96 | 0.4403 [0.3516, 0.5276] * |
...
| scene07 | 30 | 42 | 0.42 | 0.7363 | 0.5329 |
...
per-pair rows: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/eval_v2corr/depth_s43/twin/twin_pairs.csv` (`kept`/`mismatch` carry the pose-filter verdict).
