...
on: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/nightrun_0820/ctrl_dressing/eval_old_s43/per_frame_on.csv` · off: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/nightrun_0820/ctrl_dressing/eval_old_s43/per_frame_off.csv` · manifest: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/dayrun_0820/dataset_manifest_v2_full.json`
...
pairs found **48** · pose-matched (kept) **48** · excluded **0** · kept pairs carrying >=1 GT cell **24** (delta_score > 0 in 23/24)
...
|---|---|---|---|
| V | 24 | 0.7455 [0.6205, 0.8499] * | 0.7379 [0.6133, 0.8425] * |
| E | 0 | n/a [n/a, n/a] | n/a [n/a, n/a] |
| H | 0 | n/a [n/a, n/a] | n/a [n/a, n/a] |
| all | 48 | 0.7455 [0.6205, 0.8499] * | 0.4177 [0.3030, 0.5324] * |
...
| 2 [2,5) m | 12 | 0.3988 [0.2406, 0.5632] * | 0 | n/a [n/a, n/a] |
| 3a [5,8) m | 21 | 0.3772 [0.2186, 0.5402] * | 0 | n/a [n/a, n/a] |
| 3b [8,12) m | 24 | 0.7181 [0.5899, 0.8255] * | 0 | n/a [n/a, n/a] |
...
per-pair rows: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/nightrun_0820/ctrl_dressing/twin_old_s43/twin_pairs.csv` (`kept`/`mismatch` carry the pose-filter verdict).
