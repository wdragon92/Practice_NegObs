...
| cell FPR (negative cells of on frames) | 0.2647 [0.1760, 0.3662] |
...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.5185 [0.4631, 0.5692] |
| cell recall | 0.8750 [0.7848, 0.9583] |
| cell precision | 0.3684 [0.3110, 0.4350] |
...
|---|---|---|---|
| cell_f1 | 0.4848 | 0.5185 | 0.4490 |
| cell_recall | 1.0000 | 0.8750 | 0.4583 |
| cell_precision | 0.3200 | 0.3684 | 0.4400 |
...
| cell_fpr_on_neg | 0.3750 | 0.2647 | 0.1029 |
