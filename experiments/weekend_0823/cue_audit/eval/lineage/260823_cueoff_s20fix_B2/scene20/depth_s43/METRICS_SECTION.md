...
| cell FPR (negative cells of on frames) | 0.3424 [0.3041, 0.3823] |
...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.5888 [0.5471, 0.6237] |
| cell recall | 1.0000 [1.0000, 1.0000] |
| cell precision | 0.4172 [0.3766, 0.4532] |
...
|---|---|---|---|
| cell_f1 | 0.5676 | 0.5888 | 0.6131 |
| cell_recall | 1.0000 | 1.0000 | 0.9683 |
| cell_precision | 0.3962 | 0.4172 | 0.4485 |
...
| cell_fpr_on_neg | 0.3735 | 0.3424 | 0.2918 |
