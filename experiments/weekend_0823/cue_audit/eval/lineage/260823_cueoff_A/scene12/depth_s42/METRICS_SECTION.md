...
| cell FPR (negative cells of on frames) | 0.0072 [0.0000, 0.0155] |
...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.9767 [0.9483, 1.0000] |
| cell recall | 1.0000 [1.0000, 1.0000] |
| cell precision | 0.9545 [0.9016, 1.0000] |
...
|---|---|---|---|
| cell_f1 | 0.9767 | 0.9767 | 1.0000 |
| cell_recall | 1.0000 | 1.0000 | 1.0000 |
| cell_precision | 0.9545 | 0.9545 | 1.0000 |
...
| cell_fpr_on_neg | 0.0072 | 0.0072 | 0.0000 |
