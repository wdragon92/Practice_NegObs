...
| H | 0.8148 [0.6538, 0.9565] | 0.6260 [0.4643, 0.7778] | 27 |
| **any tier (frame detection rate)** | 0.8718 [0.7568, 0.9722] | — | 39 |
...
| cell FPR (negative cells of on frames) | 0.2613 [0.2203, 0.3037] |
...
| 3b [8,12) m | 0.6940 [0.5755, 0.8044] | 0.0000 [0.0000, 0.0000] |

| overall | value [95% CI] |
|---|---|
| cell F1 | 0.4951 [0.4231, 0.5568] |
| cell recall | 0.6940 [0.5755, 0.8044] |
| cell precision | 0.3848 [0.3212, 0.4436] |
...
|---|---|---|---|
| cell_f1 | 0.5035 | 0.4951 | 0.4595 |
| cell_recall | 0.7814 | 0.6940 | 0.5738 |
| cell_precision | 0.3714 | 0.3848 | 0.3832 |
