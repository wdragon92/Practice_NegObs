...
| cell FPR (negative cells of on frames) | 0.2164 [0.1671, 0.2658] |
...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.6420 [0.6032, 0.6711] |
| cell recall | 1.0000 [1.0000, 1.0000] |
| cell precision | 0.4727 [0.4318, 0.5050] |
...
|---|---|---|---|
| cell_f1 | 0.6118 | 0.6420 | 0.6842 |
| cell_recall | 1.0000 | 1.0000 | 1.0000 |
| cell_precision | 0.4407 | 0.4727 | 0.5200 |
...
| cell_fpr_on_neg | 0.2463 | 0.2164 | 0.1791 |
