...
| cell FPR (negative cells of on frames) | 0.2996 [0.2736, 0.3262] |
...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.6207 [0.5789, 0.6540] |
| cell recall | 1.0000 [1.0000, 1.0000] |
| cell precision | 0.4500 [0.4074, 0.4859] |
...
|---|---|---|---|
| cell_f1 | 0.5888 | 0.6207 | 0.6458 |
| cell_recall | 1.0000 | 1.0000 | 0.9841 |
| cell_precision | 0.4172 | 0.4500 | 0.4806 |
...
| cell_fpr_on_neg | 0.3424 | 0.2996 | 0.2607 |
