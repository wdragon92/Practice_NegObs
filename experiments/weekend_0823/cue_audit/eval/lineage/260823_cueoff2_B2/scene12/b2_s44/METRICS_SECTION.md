...
| cell FPR (negative cells of on frames) | 0.0216 [0.0067, 0.0390] |
...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.8293 [0.7000, 0.9431] |
| cell recall | 0.8095 [0.6765, 0.9344] |
| cell precision | 0.8500 [0.7231, 0.9538] |
...
|---|---|---|---|
| cell_f1 | 0.8160 | 0.8293 | 0.8430 |
| cell_recall | 0.8095 | 0.8095 | 0.8095 |
| cell_precision | 0.8226 | 0.8500 | 0.8793 |
...
| cell_fpr_on_neg | 0.0264 | 0.0216 | 0.0168 |
