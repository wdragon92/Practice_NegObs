...
arm: **rgb** · subset: **test** · ckpt: `experiments/weekend_0823/fusion/s44/fused_or/per_frame.csv`
...
## 3. Paired comparison (A = this arm, B = `experiments/dayrun_0820/runs/v2/rgb_s44/eval_test/per_frame.csv`)

816 common frames · paired percentile bootstrap 10000x seed 42 · threshold 0.5

| metric | A | B | A−B [95% CI] | CI excludes 0 |
|---|---|---|---|---|
| cell_f1 | 0.3375 | 0.3304 | 0.0071 [0.0024, 0.0124] | yes |
| cell_recall | 0.2456 | 0.2360 | 0.0097 [0.0059, 0.0138] | yes |
| cell_precision | 0.5392 | 0.5507 | -0.0116 [-0.0196, -0.0037] | yes |
| frame_det_rate | 0.5719 | 0.5505 | 0.0214 [0.0065, 0.0388] | yes |
| frame_recall_V | 0.6556 | 0.6167 | 0.0389 [0.0123, 0.0699] | yes |
| frame_recall_E | 0.1556 | 0.1556 | 0.0000 [0.0000, 0.0000] | no |
| frame_recall_H | 0.5938 | 0.5938 | 0.0000 [0.0000, 0.0000] | no |
| cell_recall_V | 0.2808 | 0.2669 | 0.0139 [0.0087, 0.0196] | yes |
| cell_recall_E | 0.0402 | 0.0402 | 0.0000 [0.0000, 0.0000] | no |
| cell_recall_H | 0.2505 | 0.2505 | 0.0000 [0.0000, 0.0000] | no |
| band1_cell_recall | 0.1026 | 0.0000 | 0.1026 [0.0519, 0.1574] | yes |
| band2_cell_recall | 0.1799 | 0.1429 | 0.0370 [0.0176, 0.0597] | yes |
| band3_cell_recall | 0.2034 | 0.2034 | 0.0000 [0.0000, 0.0000] | no |
| band4_cell_recall | 0.3047 | 0.3047 | 0.0000 [0.0000, 0.0000] | no |
| band1_cell_fpr_off | 0.0074 | 0.0000 | 0.0074 [0.0034, 0.0121] | yes |
| band2_cell_fpr_off | 0.0167 | 0.0142 | 0.0025 [0.0005, 0.0048] | yes |
| band3_cell_fpr_off | 0.0240 | 0.0240 | 0.0000 [0.0000, 0.0000] | no |
| band4_cell_fpr_off | 0.0725 | 0.0725 | 0.0000 [0.0000, 0.0000] | no |
| frame_fa_off | 0.2475 | 0.2230 | 0.0245 [0.0100, 0.0407] | yes |
| cell_fpr_off | 0.0301 | 0.0277 | 0.0025 [0.0013, 0.0037] | yes |
| cell_fpr_on_neg | 0.0583 | 0.0534 | 0.0049 [0.0032, 0.0068] | yes |
