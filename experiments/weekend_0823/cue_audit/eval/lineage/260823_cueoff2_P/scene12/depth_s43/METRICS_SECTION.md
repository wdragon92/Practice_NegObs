...
| cell FPR (negative cells of on frames) | 0.0432 [0.0137, 0.0791] |
...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.8750 [0.7922, 0.9565] |
| cell recall | 1.0000 [1.0000, 1.0000] |
| cell precision | 0.7778 [0.6559, 0.9167] |
...
|---|---|---|---|
| cell_f1 | 0.7925 | 0.8750 | 0.9333 |
| cell_recall | 1.0000 | 1.0000 | 1.0000 |
| cell_precision | 0.6562 | 0.7778 | 0.8750 |
...
| cell_fpr_on_neg | 0.0791 | 0.0432 | 0.0216 |
