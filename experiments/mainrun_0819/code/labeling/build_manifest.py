#!/usr/bin/env python3
"""Merge labels_v0.json + per-scene variation.json into the fixed manifest contract."""
import argparse, datetime, json, os, sys
from labeler import (scene_dirs, GT_SOURCE, TIER_SOURCE, FOOTPRINT_VERSION,
                     GATE_POLICY)

GT_SRC = GT_SOURCE            # D10 footprint v2 -> "derived-heightmapdiff-..."
TIER_SRC = TIER_SOURCE
...
def main():
    ...
    man = dict(meta=dict(
        ...
        grid_version=lab["grid"]["version"], gt_source=GT_SRC, tier_source=TIER_SRC,
