...
arm: **rgb** · subset: **test** · ckpt: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/weekend_0823/newmodels/runs/tu-convnext_tiny_s42/best.pt`
...
|---|---|---|---|
| V | 0.9315 [0.8950, 0.9633] | 0.1009 [0.0937, 0.1090] | 219 |
| E | 1.0000 [1.0000, 1.0000] | 0.1293 [0.1151, 0.1473] | 45 |
| H | 0.8438 [0.7692, 0.9121] | 0.1720 [0.1553, 0.1915] | 96 |
| **any tier (frame detection rate)** | 0.9024 [0.8709, 0.9316] | — | 369 |
...
| cell FPR (negative cells of on frames) | 0.0141 [0.0115, 0.0168] |
...
| 3b [8,12) m | 0.2265 [0.2191, 0.2346] | 0.2000 [0.2000, 0.2000] |

| overall | value [95% CI] |
|---|---|
| cell F1 | 0.1814 [0.1719, 0.1912] |
| cell recall | 0.1166 [0.1097, 0.1242] |
| cell precision | 0.4081 [0.3750, 0.4412] |
...
|---|---|---|---|
| cell_f1 | 0.4342 | 0.1814 | 0.0000 |
| cell_recall | 0.5893 | 0.1166 | 0.0000 |
| cell_precision | 0.3438 | 0.4081 | n/a |
| frame_det_rate | 1.0000 | 0.9024 | 0.0000 |
| frame_recall_V | 1.0000 | 0.9315 | 0.0000 |
| frame_recall_E | 1.0000 | 1.0000 | 0.0000 |
| frame_recall_H | 1.0000 | 0.8438 | 0.0000 |
| cell_recall_V | 0.5193 | 0.1009 | 0.0000 |
...
| band3_cell_recall | 0.2391 | 0.0000 | 0.0000 |
| band4_cell_recall | 1.0000 | 0.2265 | 0.0000 |
...
| cell_fpr_on_neg | 0.1442 | 0.0141 | 0.0000 |
