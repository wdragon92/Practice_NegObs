...
|---|---|---|---|
| V | 1.0000 [1.0000, 1.0000] | 0.7500 [0.6312, 0.8553] | 24 |
...
| 3b [8,12) m | 0.7241 [0.5915, 0.8571] | 0.0250 [0.0000, 0.0545] |

| overall | value [95% CI] |
|---|---|
| cell F1 | 0.7434 [0.6786, 0.7911] |
| cell recall | 0.7500 [0.6312, 0.8553] |
| cell precision | 0.7368 [0.6772, 0.7925] |
