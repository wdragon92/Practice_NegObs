...
| H | 0.9630 [0.8750, 1.0000] | 0.5447 [0.4375, 0.6531] | 27 |
...
| cell FPR (negative cells of on frames) | 0.3449 [0.2900, 0.3984] |
...
| 3b [8,12) m | 0.5191 [0.4272, 0.6154] | 0.0000 [0.0000, 0.0000] |

| overall | value [95% CI] |
|---|---|
| cell F1 | 0.3455 [0.2828, 0.4078] |
| cell recall | 0.5191 [0.4272, 0.6154] |
| cell precision | 0.2589 [0.2049, 0.3158] |
...
|---|---|---|---|
| cell_f1 | 0.4179 | 0.3455 | 0.2626 |
| cell_recall | 0.9180 | 0.5191 | 0.2131 |
| cell_precision | 0.2705 | 0.2589 | 0.3421 |
