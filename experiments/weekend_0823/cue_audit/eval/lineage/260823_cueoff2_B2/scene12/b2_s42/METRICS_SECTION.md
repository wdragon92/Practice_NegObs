...
| H | 0.8750 [0.7273, 1.0000] | 0.8095 [0.6765, 0.9344] | 24 |
...
| cell FPR (negative cells of on frames) | 0.0384 [0.0124, 0.0678] |
...
| 3b [8,12) m | 0.5000 [0.2000, 0.8000] | 0.0000 [0.0000, 0.0000] |

| overall | value [95% CI] |
|---|---|
| cell F1 | 0.7846 [0.6423, 0.9231] |
| cell recall | 0.8095 [0.6765, 0.9344] |
| cell precision | 0.7612 [0.6094, 0.9153] |
...
|---|---|---|---|
| cell_f1 | 0.7786 | 0.7846 | 0.8095 |
| cell_recall | 0.8095 | 0.8095 | 0.8095 |
| cell_precision | 0.7500 | 0.7612 | 0.8095 |
...
| cell_recall_H | 0.8095 | 0.8095 | 0.8095 |
...
| cell_fpr_on_neg | 0.0408 | 0.0384 | 0.0288 |
