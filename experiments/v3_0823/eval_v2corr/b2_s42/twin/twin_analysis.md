...
on: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/eval_v2corr/b2_s42/per_frame_on.csv` · off: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/eval_v2corr/b2_s42/per_frame_off.csv` · manifest: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/dataset_manifest_v2corr.json`
...
pairs found **408** · pose-matched (kept) **366** · excluded **42** · kept pairs carrying >=1 GT cell **327** (delta_score > 0 in 278/327)
...
|---|---|---|---|
| V | 177 | 0.2874 [0.2317, 0.3432] * | 0.2739 [0.2175, 0.3310] * |
| E | 45 | 0.0054 [0.0024, 0.0093] * | 0.0133 [0.0032, 0.0298] * |
| H | 96 | 0.0735 [0.0340, 0.1125] * | 0.0743 [0.0348, 0.1132] * |
| all | 366 | 0.1790 [0.1441, 0.2147] * | 0.1651 [0.1341, 0.1980] * |
...
| 3b [8,12) m | 327 | 0.1777 [0.1440, 0.2124] * | 96 | 0.0903 [0.0599, 0.1233] * |
...
| scene07 | 30 | 42 | 0.42 | 0.2361 | 0.1284 |
...
per-pair rows: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/eval_v2corr/b2_s42/twin/twin_pairs.csv` (`kept`/`mismatch` carry the pose-filter verdict).
