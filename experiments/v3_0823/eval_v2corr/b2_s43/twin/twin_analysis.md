...
on: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/eval_v2corr/b2_s43/per_frame_on.csv` · off: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/eval_v2corr/b2_s43/per_frame_off.csv` · manifest: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/dataset_manifest_v2corr.json`
...
|---|---|---|---|
| V | 177 | 0.3978 [0.3638, 0.4306] * | 0.3991 [0.3651, 0.4319] * |
| E | 45 | 0.1998 [0.1252, 0.2762] * | 0.2008 [0.1264, 0.2766] * |
| H | 96 | 0.0688 [0.0507, 0.0880] * | 0.0796 [0.0617, 0.0979] * |
| all | 366 | 0.2686 [0.2419, 0.2960] * | 0.2550 [0.2301, 0.2803] * |
...
| 3b [8,12) m | 327 | 0.2618 [0.2347, 0.2897] * | 96 | 0.0588 [0.0427, 0.0757] * |
...
| scene07 | 30 | 42 | 0.42 | 0.4220 | 0.4113 |
...
per-pair rows: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/v3_0823/eval_v2corr/b2_s43/twin/twin_pairs.csv` (`kept`/`mismatch` carry the pose-filter verdict).
