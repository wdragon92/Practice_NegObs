...
| cell FPR (negative cells of on frames) | 0.2724 [0.2203, 0.3298] |
...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.6429 [0.5924, 0.6927] |
| cell recall | 1.0000 [1.0000, 1.0000] |
| cell precision | 0.4737 [0.4208, 0.5299] |
...
|---|---|---|---|
| cell_f1 | 0.5753 | 0.6429 | 0.7412 |
| cell_recall | 1.0000 | 1.0000 | 1.0000 |
| cell_precision | 0.4038 | 0.4737 | 0.5888 |
...
| cell_fpr_on_neg | 0.3619 | 0.2724 | 0.1712 |
