...
on: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/probe_holes_0820/eval/depth_s43/per_frame_on.csv` · off: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/probe_holes_0820/eval/depth_s43/per_frame_off.csv` · manifest: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/probe_holes_0820/dataset_manifest_probe.json`
...
|---|---|---|---|
| V | 15 | 0.0755 [0.0305, 0.1218] * | 0.1939 [0.0935, 0.2981] * |
| E | 27 | 0.0347 [0.0152, 0.0587] * | 0.0872 [0.0422, 0.1414] * |
| H | 30 | -0.0000 [-0.0000, -0.0000] * | 0.0000 [0.0000, 0.0000] |
| all | 72 | 0.0288 [0.0159, 0.0437] * | 0.0731 [0.0432, 0.1081] * |
...
|---|---|---|---|---|
| 1 [0,2) m | 6 | 0.0516 [-0.0000, 0.1031] | 3 | -0.0000 [-0.0000, -0.0000] * |
| 2 [2,5) m | 51 | 0.0238 [0.0110, 0.0400] * | 21 | -0.0000 [-0.0000, 0.0000] |
| 3a [5,8) m | 21 | 0.0334 [0.0165, 0.0530] * | 3 | 0.0000 [0.0000, 0.0000] |
| 3b [8,12) m | 18 | 0.0309 [-0.0006, 0.0674] | 9 | 0.0000 [0.0000, 0.0000] |
...
|---|---|---|---|---|---|
| probeH1 | 24 | 0 | 1.00 | 0.0708 | 0.1752 |
| probeH2 | 24 | 0 | 1.00 | 0.0155 | 0.0440 |
| probeH3 | 24 | 0 | 1.00 | 0.0000 | 0.0000 |

per-pair rows: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/probe_holes_0820/eval/depth_s43/twin/twin_pairs.csv` (`kept`/`mismatch` carry the pose-filter verdict).
