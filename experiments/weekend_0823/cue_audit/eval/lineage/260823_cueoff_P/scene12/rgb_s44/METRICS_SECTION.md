...
| cell FPR (negative cells of on frames) | 0.0192 [0.0059, 0.0348] |
...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.9403 [0.8976, 0.9799] |
| cell recall | 1.0000 [1.0000, 1.0000] |
| cell precision | 0.8873 [0.8143, 0.9605] |
...
|---|---|---|---|
| cell_f1 | 0.9197 | 0.9403 | 0.9688 |
| cell_recall | 1.0000 | 1.0000 | 0.9841 |
| cell_precision | 0.8514 | 0.8873 | 0.9538 |
...
| band4_cell_recall | 1.0000 | 1.0000 | 0.9778 |
...
| cell_fpr_on_neg | 0.0264 | 0.0192 | 0.0072 |
