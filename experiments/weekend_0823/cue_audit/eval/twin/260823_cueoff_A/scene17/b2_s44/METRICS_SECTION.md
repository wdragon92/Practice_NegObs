...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.9966 [0.9876, 1.0000] |
| cell recall | 1.0000 [1.0000, 1.0000] |
| cell precision | 0.9932 [0.9754, 1.0000] |
...
|---|---|---|---|
| cell_f1 | 0.9767 | 0.9966 | 1.0000 |
| cell_recall | 1.0000 | 1.0000 | 1.0000 |
| cell_precision | 0.9545 | 0.9932 | 1.0000 |
...
| cell_fpr_on_neg | 0.0150 | 0.0000 | 0.0000 |
