...
| cell FPR (negative cells of on frames) | 0.0048 [0.0000, 0.0120] |
...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.9844 [0.9600, 1.0000] |
| cell recall | 1.0000 [1.0000, 1.0000] |
| cell precision | 0.9692 [0.9231, 1.0000] |
...
|---|---|---|---|
| cell_f1 | 0.9692 | 0.9844 | 0.9921 |
| cell_recall | 1.0000 | 1.0000 | 1.0000 |
| cell_precision | 0.9403 | 0.9692 | 0.9844 |
...
| cell_fpr_on_neg | 0.0096 | 0.0048 | 0.0024 |
