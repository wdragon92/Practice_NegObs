...
|---|---|
| frame-FA rate (off frames) | 0.4375 [0.2979, 0.5818] |
| cell FPR (off frames) | 0.1094 [0.0570, 0.1685] |
| cell FPR (negative cells of on frames) | 0.0207 [0.0087, 0.0342] |

| distance band | cell recall [95% CI] | cell FPR on off-arm [95% CI] |
|---|---|---|
| 1 [0,2) m | n/a [n/a, n/a] | 0.0000 [0.0000, 0.0000] |
| 2 [2,5) m | 0.0588 [0.0000, 0.1273] | 0.0625 [0.0000, 0.1373] |
| 3a [5,8) m | 0.5185 [0.3295, 0.7167] | 0.1375 [0.0571, 0.2267] |
| 3b [8,12) m | 0.8000 [0.7238, 0.8800] | 0.2375 [0.1469, 0.3333] |

| overall | value [95% CI] |
|---|---|
| cell F1 | 0.5309 [0.4165, 0.6323] |
| cell recall | 0.5443 [0.4398, 0.6615] |
| cell precision | 0.5181 [0.3565, 0.6854] |
...
|---|---|---|---|
| cell_f1 | 0.6011 | 0.5309 | 0.4412 |
| cell_recall | 0.6962 | 0.5443 | 0.3797 |
| cell_precision | 0.5288 | 0.5181 | 0.5263 |
...
| band2_cell_fpr_off | 0.0750 | 0.0625 | 0.0625 |
| band3_cell_fpr_off | 0.1375 | 0.1375 | 0.1000 |
| band4_cell_fpr_off | 0.3250 | 0.2375 | 0.1500 |
| frame_fa_off | 0.5000 | 0.4375 | 0.2500 |
| cell_fpr_off | 0.1344 | 0.1094 | 0.0781 |
