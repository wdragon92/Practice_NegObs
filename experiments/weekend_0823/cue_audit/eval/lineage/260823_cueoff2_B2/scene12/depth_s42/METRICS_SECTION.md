...
| cell FPR (negative cells of on frames) | 0.2302 [0.1433, 0.3238] |
...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.5676 [0.4813, 0.6749] |
| cell recall | 1.0000 [1.0000, 1.0000] |
| cell precision | 0.3962 [0.3169, 0.5093] |
...
|---|---|---|---|
| cell_f1 | 0.5385 | 0.5676 | 0.6087 |
| cell_recall | 1.0000 | 1.0000 | 1.0000 |
| cell_precision | 0.3684 | 0.3962 | 0.4375 |
...
| cell_fpr_on_neg | 0.2590 | 0.2302 | 0.1942 |
