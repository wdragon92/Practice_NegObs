...
| cell FPR (negative cells of on frames) | 0.1642 [0.1154, 0.2176] |
...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.7027 [0.6628, 0.7439] |
| cell recall | 1.0000 [1.0000, 1.0000] |
| cell precision | 0.5417 [0.4957, 0.5922] |
...
|---|---|---|---|
| cell_f1 | 0.6047 | 0.7027 | 0.7879 |
| cell_recall | 1.0000 | 1.0000 | 1.0000 |
| cell_precision | 0.4333 | 0.5417 | 0.6500 |
...
| cell_fpr_on_neg | 0.2537 | 0.1642 | 0.1045 |
