...
- ep1 붕괴 소멸(best ep 9/23/25/15/30). RGB의 H가 확장 H셋에서 Depth를 앞서 보이나 **FA가
  8.6배 다른 지점의 비교**다(RGB .359 / Depth .042). FA 정합 시 역전 없음 — 사후 D41① 정정.
  (원수치 0.59-0.88 vs 0.41-0.47.) Depth FA
