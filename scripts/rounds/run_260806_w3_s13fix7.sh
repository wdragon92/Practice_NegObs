#!/bin/bash
# =============================================================================
# S13 6차 답변 라운드 (GT-64: 정남향 판상 그리드·남북 교차로·계단박스 개폐) — scene13 단독 PT (round = 260806_w3_s13fix7)
#   근거: 08-06 사용자 답변 — ledger GT-64 선신고 참조
#   재질 팔: 260805_w3_doctrine 과 동일 (LOOK_V1=1 · DETAIL_SCALE=2 · ROUGH_GAIN=0)
#   baseline (회귀): 260806_w3_s13fix6
# =============================================================================
