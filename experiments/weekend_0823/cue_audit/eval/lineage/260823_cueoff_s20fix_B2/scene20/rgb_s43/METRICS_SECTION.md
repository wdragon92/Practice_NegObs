...
| H | 1.0000 [1.0000, 1.0000] | 0.8837 [0.8392, 0.9276] | 27 |
...
| cell FPR (negative cells of on frames) | 0.2918 [0.2150, 0.3687] |
...
| 3b [8,12) m | 0.9206 [0.8852, 0.9543] | 0.7000 [0.5793, 0.8100] |

| overall | value [95% CI] |
|---|---|
| cell F1 | 0.5095 [0.4371, 0.5772] |
| cell recall | 0.9206 [0.8852, 0.9543] |
| cell precision | 0.3522 [0.2860, 0.4212] |
...
|---|---|---|---|
| cell_f1 | 0.4450 | 0.5095 | 0.5558 |
| cell_recall | 0.9630 | 0.9206 | 0.8042 |
| cell_precision | 0.2893 | 0.3522 | 0.4246 |
