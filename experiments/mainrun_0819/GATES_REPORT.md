# GATES_REPORT — PROVISIONAL-GRID-V0

manifest: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/mainrun_0819/dataset_manifest_v1.json`  (1584 frames)
grid: `PROVISIONAL-GRID-V0`  gt_source: `derived-heightmapdiff-gridv0-PROVISIONAL`  tier_source: `derived-depth-v0-strict`
...
D17 mislabel-risk (`scene11`, `scene13`, `scene19`) — hand-listed scene(s) whose hazard-ON labels are suspected WRONG, not merely absent; training on them would teach that a real edge is safe. This list is an input, not a measurement — gates.py cannot detect a mislabel. Source: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/mainrun_0819/annotations/extra_holds.json`.
Machine-readable: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/mainrun_0819/annotations/hold_scenes.json`  →  `make_split.py --exclude-scenes @/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/mainrun_0819/annotations/hold_scenes.json`
...
## G2 toggle sanity — FAIL (with 4 scene(s) on PROVISIONAL-HOLD)
off-arm frames with residual footprint: 0 (scenes flagged: none)
on-arm scenes with ZERO positive frames: ['scene06']
...
| scene03 | on | 67695 | 64592 | 3103 | 12/24 | 45 |
...
| scene07 | on | 18874 | 9925–9943 | 8931–8949 | 18/24 | 39 |
...
## G5 V-tier depth/GT agreement — FAIL/NA
V frames scored: 438   mean agreement: 0.552  (target >= 0.80)
...
| 3 (5.0-12.0 m) | 0.715 | 1782 |
> A near band scoring low is expected geometry, not a labeling fault: a drop's floor right behind the lip sits in the camera's view shadow, so its cell is GT-positive with no visible below-ground surface. Judge the 0.80 target on the far bands, or re-cut the target, before treating G5 as a data defect.
...
dir: `/home/vislab/Desktop/work_sy/Practice_NegObs/experiments/mainrun_0819/audit_samples`
tier mix: {'E': 7, 'V': 13, 'H': 3, 'off': 3, 'H_weak': 2, 'none_in_fov': 2}
D12 far-E quota (tier E and cam.d > 8.0 m): 6/4
...
| scene06 | 5.005 | 0.0003 | 0.00× | aabb/aabb | **BROKEN — on-arm zero positives** |
...
**Still measuring zero on the hazard arm after the depth-fusion rescue: `scene06`** — these fail G2 above and are reported, not auto-held (D14).
