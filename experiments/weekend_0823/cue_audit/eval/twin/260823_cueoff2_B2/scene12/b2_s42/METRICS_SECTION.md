...
| cell FPR (negative cells of on frames) | 0.0224 [0.0059, 0.0420] |

| distance band | cell recall [95% CI] | cell FPR on off-arm [95% CI] |
|---|---|---|
| 1 [0,2) m | n/a [n/a, n/a] | 0.0000 [0.0000, 0.0000] |
| 2 [2,5) m | 0.0000 [0.0000, 0.0000] | 0.0000 [0.0000, 0.0000] |
| 3a [5,8) m | 0.6667 [0.5333, 0.7937] | 0.3250 [0.2250, 0.4231] |
| 3b [8,12) m | 0.1379 [0.0506, 0.2286] | 0.2000 [0.1200, 0.2815] |

| overall | value [95% CI] |
|---|---|
| cell F1 | 0.4027 [0.3404, 0.4514] |
| cell recall | 0.3571 [0.3224, 0.3986] |
| cell precision | 0.4615 [0.3307, 0.5952] |
...
| cell_fpr_on_neg | 0.0256 | 0.0224 | 0.0096 |
