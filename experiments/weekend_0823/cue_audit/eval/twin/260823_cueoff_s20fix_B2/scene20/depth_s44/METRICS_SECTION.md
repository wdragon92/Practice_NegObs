...
| cell FPR (negative cells of on frames) | 0.2646 [0.2138, 0.3199] |
...
| overall | value [95% CI] |
|---|---|
| cell F1 | 0.6495 [0.5988, 0.6989] |
| cell recall | 1.0000 [1.0000, 1.0000] |
| cell precision | 0.4809 [0.4273, 0.5372] |
...
|---|---|---|---|
| cell_f1 | 0.5753 | 0.6495 | 0.7456 |
| cell_recall | 1.0000 | 1.0000 | 1.0000 |
| cell_precision | 0.4038 | 0.4809 | 0.5943 |
...
| cell_fpr_on_neg | 0.3619 | 0.2646 | 0.1673 |
