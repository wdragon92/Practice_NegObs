#!/bin/bash
# =============================================================================
# S13 gallery answer round 3 — scene13 solo PT (round = 260805_w3_s13fix4)
#   Authority: user 4th answer 08-05 (building-form structure, glass curtain
...
#   Regression baseline: 260805_w3_s13fix3 (round-over-round)
# =============================================================================
